...
class LinearTrajectory(Trajectory):
    ...
    def target_pose(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            pos = self.goal_position - (1/2) * self.acceleration * (self.total_time / 2 - (time - self.total_time / 2)) ** 2
    ...
    def target_velocity(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            linear_vel = self.v_max - (time - self.total_time/2.0) * self.acceleration
...
class CircularTrajectory(Trajectory):
    ...
    def target_pose(self, time):
        ...
        if time <= self.total_time / 2.0:
            ...
            theta = self.angular_v_max * (time - self.total_time / 2) + np.pi - (1/2) * self.angular_acceleration * (time - self.total_time / 2) ** 2
